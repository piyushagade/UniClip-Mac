...
//   icon: 'file://' + __dirname + '/img' + '/clipboard.png', 
//   alwaysOnTop: true,
//   width: 400,
//   height: 400,
//   resizable: false,
...
var cb_notifications_enabled;
  ...
  app.dock.setIcon(path.join(__dirname, 'img/circle_logo.png'));
...
app.on('ready', function(){
  ...
  appIcon.setPressedImage(path.join(__dirname, 'img/clipboard_pressed.png'));
      ...
      { label: 'Quit UniClip!',
        ...
        click: function() {
          ...
          resetReauthorization();
		      notify("UniClip!","UniClip is shutting down.", false);
...
function createWindow () {
  ...
  mainWindow = new BrowserWindow({width: width, height: 600, frame: false, 'titleBarStyle': 'hidden', resizable: false, alwaysOnTop: false, fullscreenable: false, skipTaskbar: false, kiosk: false, title: 'UniClip!', icon : __dirname + '/img/circle_logo.png', movable: true});
  ...
  //Difference in Windows and Linux code
	...
	var ret_btf = globalShortcut.register('ctrl+shift+u', function() {
	    if(winHidden) {
			...
			app.dock.hide();
	        notify("UniClip running in background","Press Ctrl+Shift+U to show it again.", false)
	        winHidden=true;
